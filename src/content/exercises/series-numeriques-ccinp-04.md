...
correction: |
  ...
  = n\pi + \frac\pi2 + \frac{3\pi}{8n} + O(1/n^2)$. Donc $\alpha = \frac{3\pi}{8}$.

  2. En posant $v_n = \cos(\pi\sqrt{n^2+n+1})$, la question 1 donne $v_n = \cos\left(n\pi+\frac\pi2+\frac{3\pi}{8n}
  +O(1/n^2)\right) = (-1)^{n+1}\sin\left(\frac{3\pi}{8n}+O(1/n^2)\right) = \frac{3\pi}{8}\cdot\frac{(-1)^{n+1}}{n}
  + O(1/n^2)$. Le premier terme donne une série convergente (CSSA), le second une série absolument convergente

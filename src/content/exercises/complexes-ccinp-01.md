...
correction: |
  ...
  2. $z=0$ n'est pas solution. En écrivant $z=re^{i\theta}$ ($r>0$), $z^n=1 \iff r=1$ et $\theta \equiv \frac{2k\pi}{n}\ [2\pi]$. Les $n$ valeurs $e^{i2k\pi/n}$, $k \in \llbracket 0,n-1\rrbracket$, sont deux à deux
  ...
  3. $z=i$ n'est pas solution. $(z+i)^n=(z-i)^n \iff \left(\frac{z+i}{z-i}\right)^n=1 \iff \exists k \in \llbracket 0,n-1\rrbracket,\ \frac{z+i}{z-i}=e^{i2k\pi/n}$. Le cas $k=0$ est impossible ; pour
